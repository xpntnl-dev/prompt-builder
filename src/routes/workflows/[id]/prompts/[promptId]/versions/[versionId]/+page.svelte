...
<div class="space-y-6">
	...
	<div class="flex items-center space-x-2 text-sm text-gray-500">
		...
		<span>→</span>
		<span class="text-gray-900 font-medium">{data.version.version_tag}</span>
	</div>
		...
		<div class="flex-1">
			<div class="flex items-center space-x-3 mb-2">
				<h1 class="text-3xl font-bold text-gray-900">
					...
					<span class="text-gray-500 text-xl">v{data.version.version_number}</span>
				</h1>
			...
			<div class="text-gray-600 text-sm">
				Model: {data.version.model_provider}/{data.version.model_name}
			</div>
		</div>
